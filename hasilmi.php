...
$toko = query("SELECT * FROM minuman");
...
<body>
    <h1>Daftar Beli Minuman</h1>
    <div class="d-flex justify-content-center">
    <button type="submit" class="btn btn-primary"><a href="belimi.php">Beli Lagi?</a></button></div>
    <div class="d-flex justify-content-center">
        ...
        <tbody>
            ...
            <?php foreach($toko as $valo) { ?>
                <tr>
                    ...
                    <td><?= $valo["aqua"] ?></td>
                    <td>
                    <a class="btn btn-primary" href="editmi.php?id= <?= $valo["id"] ?>" role="button">Ubah</a> |
                    <a class="btn btn-primary" href="hapusmi.php?id= <?= $valo["id"] ?>" role="button" onclick="return confirm('Yakin?');">Hapus</a>
                </td>
