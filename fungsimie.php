...
function tambah($data){
    ...
    $query ="INSERT INTO mie
         VALUES('', '$nama', '$ayam', '$soto','$goreng','$aceh','$korea','$geprek','$rendang','$sarimi')";
...
function hapus($id){
    global $conn;
    mysqli_query($conn, "DELETE FROM mie WHERE id= $id");
...
function cari($keyword){
    $query="SELECT * FROM mie WHERE
            nama LIKE '%$keyword%'OR
            ayam LIKE '%$keyword%'OR
            soto LIKE '%$keyword%'OR
            goreng LIKE '%$keyword%'OR
            aceh LIKE '%$keyword%'OR
            korea LIKE '%$keyword%'OR
            geprek LIKE '%$keyword%'OR
            rendang LIKE '%$keyword%'OR
            sarimi LIKE '%$keyword%'";
    return query($query);
}
