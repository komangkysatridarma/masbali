<?php
include 'fungsica.php';
// $jumlah = new jumlah();

if(isset($_POST["submit"])){

    if( tambah($_POST) > 0){
        echo "<script>alert('Data berhasil disimpan.');window.location='hasilca.php';</script>";
    }
    else{
         echo "<script>alert('Data gagal disimpan.');window.location='hasilca.php';</script>";
    }
}
?>
...
<div class="box">
        <div class="container">
            ...
            <div class="input-field">
                ...
                <div class="input-field">
                    <input type="number" name="downy" class="input" placeholder="Downy" required>
                    <i class="bx bx-user"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="soklin" class="input" placeholder="So-Klin" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="lantai" class="input" placeholder="Lantai" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="proclin" class="input" placeholder="Proclin" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="rinso" class="input" placeholder="Rinso" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="daia" class="input" placeholder="Daia" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="molto" class="input" placeholder="Molto" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="jaz1" class="input" placeholder="Jaz1" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
