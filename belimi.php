<?php
include 'fungsimi.php';
// $jumlah = new jumlah();

if(isset($_POST["submit"])){

    if( tambah($_POST) > 0){
        echo "<script>alert('Data berhasil disimpan.');window.location='hasilmi.php';</script>";
    }
    else{
         echo "<script>alert('Data gagal disimpan.');window.location='hasilmi.php';</script>";
    }
}
?>
...
<div class="box">
        <div class="container">
            ...
            <div class="input-field">
                ...
                <div class="input-field">
                    <input type="number" name="tehgelas" class="input" placeholder="Teh Gelas" required>
                    <i class="bx bx-user"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="ale" class="input" placeholder="Ale-Ale" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="rio" class="input" placeholder="Teh Rio" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="kopikap" class="input" placeholder="Kopikap" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="sprite" class="input" placeholder="Sprite" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="coca" class="input" placeholder="Coca-Cola" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="okky" class="input" placeholder="Okky Jelly Drink" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="aqua" class="input" placeholder="Aqua" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
