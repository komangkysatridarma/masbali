<?php
include 'fungsimie.php';
// $jumlah = new jumlah();

if(isset($_POST["submit"])){

    if( tambah($_POST) > 0){
        echo "<script>alert('Data berhasil disimpan.');window.location='hasilmie.php';</script>";
    }
    else{
         echo "<script>alert('Data gagal disimpan.');window.location='hasilmie.php';</script>";
    }
}
?>
...
<div class="box">
        <div class="container">
            ...
            <div class="input-field">
                ...
                <div class="input-field">
                    <input type="number" name="ayam" class="input" placeholder="Indomie Ayam Bawang" required>
                    <i class="bx bx-user"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="soto" class="input" placeholder="Indomie Soto" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="goreng" class="input" placeholder="Indomie Goreng" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="aceh" class="input" placeholder="Indomie Goreng Aceh" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="korea" class="input" placeholder="Sedaap Korea Selection" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="geprek" class="input" placeholder="Indomie Ayam Geprek" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="rendang" class="input" placeholder="Indomie Rendang" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="sarimi" class="input" placeholder="Sarimi Ayam Bawang" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
