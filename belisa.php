<?php
include 'fungsisa.php';
// $jumlah = new jumlah();

if(isset($_POST["submit"])){

    if( tambah($_POST) > 0){
        echo "<script>alert('Data berhasil disimpan.');window.location='hasilsa.php';</script>";
    }
    else{
         echo "<script>alert('Data gagal disimpan.');window.location='hasilsa.php';</script>";
    }
}
?>
...
<div class="box">
        <div class="container">
            ...
            <div class="input-field">
                ...
                <div class="input-field">
                    <input type="number" name="dettol" class="input" placeholder="Dettol" required>
                    <i class="bx bx-user"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="giv" class="input" placeholder="Giv" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="lifebouy" class="input" placeholder="Lifebouy" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="nuvo" class="input" placeholder="Nuvo" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="fres" class="input" placeholder="Fres" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="lux" class="input" placeholder="Lux" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="zen" class="input" placeholder="Zen" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
