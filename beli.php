...
<div class="box">
        <div class="container">
            ...
            <div class="input-field">
                ...
                <div class="input-field">
                    <input type="number" name="aoka" class="input" placeholder="Aoka" required>
                    <i class="bx bx-user"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="nabati" class="input" placeholder="Nabati" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="bengbeng" class="input" placeholder="Bengbeng" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="wafello" class="input" placeholder="Wafello" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="chocolatos" class="input" placeholder="Chocolatos" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="potato" class="input" placeholder="Go-Potato" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="klik" class="input" placeholder="Klik" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="sosis" class="input" placeholder="Sosis So-Nice" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
