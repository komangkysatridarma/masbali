...
<body>
    <h1>Daftar Beli Mie</h1>
    <div class="d-flex justify-content-center">
    <button type="submit" class="btn btn-primary"><a href="belimie.php">Beli Lagi?</a></button></div>
    <div class="d-flex justify-content-center">
        ...
        <tbody>
            ...
            <?php foreach($toko as $valo) { ?>
                <tr>
                    ...
                    <td><?= $valo["sarimi"] ?></td>
                    <td>
                    <a class="btn btn-primary" href="editmie.php?id= <?= $valo["id"] ?>" role="button">Ubah</a> |
                    <a class="btn btn-primary" href="hapusmie.php?id= <?= $valo["id"] ?>" role="button" onclick="return confirm('Yakin?');">Hapus</a>
                </td>
