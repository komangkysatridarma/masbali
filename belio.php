...
if(isset($_POST["submit"])){
    ...
    if( tambah($_POST) > 0){
        echo "<script>alert('Data berhasil disimpan.');window.location='hasilo.php';</script>";
    }
    else{
         echo "<script>alert('Data gagal disimpan.');window.location='hasilo.php';</script>";
    }
}
?>
...
<div class="box">
        <div class="container">
            ...
            <div class="input-field">
                ...
                <div class="input-field">
                    <input type="number" name="bodrex" class="input" placeholder="Bodrex" required>
                    <i class="bx bx-user"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="oskadon" class="input" placeholder="Oskadon" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="ultraflu" class="input" placeholder="Ultraflu" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="paramex" class="input" placeholder="Paramex" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="mixagrip" class="input" placeholder="Mixagrip" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="panadol" class="input" placeholder="Panadol" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="tolakangin" class="input" placeholder="Tolakangin" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-field">
                    <input type="number" name="diapet" class="input" placeholder="Diapet" required>
                    <i class="bx bx-lock-alt"></i>
                </div>
