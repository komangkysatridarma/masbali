...
<body>
    ...
    <a href="#" class="navbar-logo">Mas<span>Bali</span>.</a>
      <div class="navbar-nav">
        ...
        if($hour >=0 && $hour <=11){
            echo "<a href=",">Selamat Pagi! </a>";
        }
        elseif($hour >=12 && $hour <=15){
            echo "<a href=",">Selamat Siang!</a>";
        }
        elseif($hour >=16 && $hour <=18){
            echo "<a href=",">Selamat Sore!</a>";
        }
        elseif($hour >=19 && $hour <=23){
            echo "<a href=",">Selamat Malam!</a>";
        }
        ?>
      ...
      <section class="hero" id="home">
        <main class="content">
            <div class="ket">
                <h1 class="animate__animated animate__fadeInDown animate__faster-1000ms">Selamat <span>Datang</span></h1>
                <p class="animate__animated animate__fadeInDown animate__faster-1000ms">Di Warung Mas Bali</p>
            </div>
          <div class="foto">
            <img class="animate__animated animate__fadeInDown animate__faster-1000ms" src="img/keluargah.png" alt="">
          </div>
        </main>
      </section>

      <section id="about" class="about">
        <h2 class="animate__animated animate__fadeInDown animate__faster-1000ms"><span>Tentang</span> Kami</h2>
